...
const shimmer = { background: "var(--surface-2)", borderRadius: 4, animation: "ws-shimmer 1.4s var(--ease-in-out) infinite" };
const card = (opacity) => ({
 ...
 */
export function Skeleton({ caption = "Loading…", count = 3 }) {
  const opacities = [1, 0.8, 0.6];
  return (
    <div style={{ marginTop: 30 }}>
      <div style={{ display: "flex", alignItems: "center", gap: 10, marginBottom: 16 }}>
        <OrganicLoader variant="enso" size={18} aria-hidden="true" style={{ flex: "none" }} />
