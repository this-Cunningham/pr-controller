...
import { SENSITIVITY_LEVELS, DEFAULT_SENSITIVITY, clampSensitivity, sensitivityPrompt } from '../sensitivity.mjs';
...
test('5 ordered levels, each with the fields the daemon + UI depend on', () => {
  ...
  for (const L of SENSITIVITY_LEVELS) {
    for (const k of ['key', 'name', 'short', 'badgeTone', 'tagline', 'handles', 'surfaces', 'prompt'])
